...
const DupontAnalysis = () => {
    ...
    return (
        <div className="bg-red-600 text-white p-6 rounded-lg shadow-lg max-w-lg mx-auto my-8">
            ...
            {selectedYear && (
                <div className="bg-white text-red-600 p-4 rounded-lg shadow-inner">
                    <h3 className="text-2xl font-semibold mb-2 text-center">Resultados del análisis Dupont - Año {selectedYear}</h3>
                    ...
                    <p className="mb-2"><span className="font-semibold">Apalancamiento:</span> {dupont?.apalancamiento}</p>
                    <p className="mb-2"><span className="font-semibold">Retorno sobre Capital:</span> {dupont?.retornoSobreCapital}%</p>
                </div>
            )}
        </div>
    );
